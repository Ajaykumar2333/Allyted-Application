...
function renderLevel3Navbar($approval_templates, $employee_name) {
    global $menu_config;
    // Fallback for employee_name and approval_templates
    ...
    // Level 3 extra menus
    if (isset($menu_config['level3_extras'])) {
...
echo renderLevel3Navbar($_SESSION['approval_templates'] ?? [], $_SESSION['employee_name'] ?? 'User');
?>